...
- Sales trend analysis (store-level, product-family-level)
- Promotion vs. sales analysis
- Monthly, yearly, and day-of-week sales patterns
...
- Lag sales, Rolling averages, Rolling sums
- Previous-day / previous-week / previous-month sales

**Business Features**
- Store number, Product family, Promotion indicators
- Holiday indicators, Store cluster, Store type, Oil price

## 🔎 Important Business Factors

**🎉 Holidays and Events**
Special attention is given to transferred holidays, bridge days, work days, and additional holidays. A transferred holiday is officially moved to another date, while bridge and work days can change normal purchasing and working patterns.

**🛢️ Oil Prices**
Ecuador's economy is influenced by oil prices, so daily oil price information is used as an external forecasting indicator.

**💰 Pay Days**
Public-sector wages are paid every two weeks — on the 15th and on the last day of the month — which may influence supermarket purchasing behavior.
...
- The influence of external factors (oil prices, pay days, earthquakes)
